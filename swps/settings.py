...
project_name = 'swps'
site_url = '.yourwebsiteprogress.com'
SITE_ID = 1
...
CMS_TEMPLATES = (
    ...
    ('cms/remodels.html', gettext('Remodels')),
    ('cms/tile_cleaning.html', gettext('Tile Cleaning')),
    ('cms/commercial.html', gettext('Commercial Services')),
)
